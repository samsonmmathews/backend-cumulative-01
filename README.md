...
We are also adding a new file:
/Views/Teacher/Edit.cshtml - A View which uses server rendering to display a page that allows for a user to Update a teacher